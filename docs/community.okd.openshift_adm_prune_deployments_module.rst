.. _community.okd.openshift_adm_prune_deployments_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specify the minimum age (in minutes) of a deployment for it to be considered a candidate for pruning.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>If <code>true</code>, prune all deployments where the associated DeploymentConfig no longer exists, the status is complete or failed, and the replica size is <code>0</code>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>list of replication controllers candidate for pruning.</div>
                    <br/>
                </td>
            </tr>
    </table>
