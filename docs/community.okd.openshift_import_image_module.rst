.. _community.okd.openshift_import_image_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>If set to <em>true</em>, import all tags from the provided source on creation or if <code>source</code> is specified.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Image stream to import tag into.</div>
                        <div>This can be provided as a list of images streams or a single value.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>source</b>&nbsp;&larr;</div></li>
                                    <li>local</li>
                        </ul>
                </td>
                <td>
                        <div>Allow to request pullthrough for external image when set to <em>local</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>Set each imported Docker image to be periodically imported from a remote repository.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>A Docker image repository to import images from.</div>
                        <div>Should be provided as &#x27;registry.io/repo/image&#x27;</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>If set to <em>true</em>, allow importing from registries that have invalid HTTPS certificates. or are hosted via HTTP. This parameter will take precedence over the insecure annotation.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>List with all ImageStreamImport that have been created.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
