.. _community.okd.openshift_route_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specify the labels to apply to the created Route.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The desired name of the Route to be created.</div>
                        <div>Defaults to the value of <em>service</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>The namespace of the resource being targeted.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The path for the Route</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Name or number of the port the Route will route traffic to.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The name of the service to expose.</div>
                        <div>Required when <em>state</em> is not absent.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: svc</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    ...
                                    <li>passthrough</li>
                                    <li>reencrypt</li>
                                    <li><div style="color: blue"><b>insecure</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
                        <div>The termination type of the Route.</div>
                        <div>If left empty no termination type will be set, and the route will be insecure.</div>
                        <div>When set to insecure <em>tls</em> will be ignored.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>TLS configuration for the newly created route.</div>
                        <div>Only used when <em>termination</em> is set.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Path to a CA certificate file on the target host.</div>
                        <div>Not supported when <em>termination</em> is set to passthrough.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Path to a certificate file on the target host.</div>
                        <div>Not supported when <em>termination</em> is set to passthrough.</div>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>destination_ca_certificate</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>Path to a CA certificate file used for securing the connection.</div>
                        <div>Only used when <em>termination</em> is set to reencrypt.</div>
                        <div>Defaults to the Service CA.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>allow</li>
                                    <li>redirect</li>
                                    <li><div style="color: blue"><b>disallow</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
                        <div>Sets the InsecureEdgeTerminationPolicy for the Route.</div>
                        <div>Not supported when <em>termination</em> is set to reencrypt.</div>
                        <div>When <em>termination</em> is set to passthrough, only redirect is supported.</div>
                        <div>If not provided, insecure traffic will be disallowed.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Path to a key file on the target host.</div>
                        <div>Not supported when <em>termination</em> is set to passthrough.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>The wildcard policy for the hostname.</div>
                        <div>Currently only Subdomain is supported.</div>
                        <div>If not provided, the default of None will be used.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The Route object that was created or updated. Will be empty in the case of deletion.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The name of the created Route</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>The namespace of the create Route</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Specification for the Route</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>Host is an alias/DNS that points to the service.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Path that the router watches for, to route traffic for to the service.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Defines a port mapping from a router to an endpoint in the service endpoints.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The target port on pods selected by the service this route points to.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>Defines config used to secure a route and provide termination.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>Provides the cert authority certificate contents.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Provides certificate contents.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Provides the contents of the ca certificate of the final destination.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>insecureEdgeTerminationPolicy</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                    </div>
                ...
                <td></td>
                <td>
                            <div>Indicates the desired behavior for insecure connections to a route.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Provides key file contents.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Indicates termination type.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>Specifies the target that resolve into endpoints.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The kind of target that the route is referring to. Currently, only &#x27;Service&#x27; is allowed.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Name of the service/target that is being referred to. e.g. name of the service.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Specifies the target&#x27;s relative weight against other target reference objects.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>Wildcard policy if any for the route.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Current status details for the Route</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>List of places where the route may be exposed.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>Array of status conditions for the Route ingress.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The status of the condition. Can be True, False, Unknown.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>The type of the condition. Currently only &#x27;Ready&#x27;.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The host string under which the route is exposed.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>The external host name for the router that can be used as a CNAME for the host requested for this route. May not be set.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>A name chosen by the router to identify itself.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>The wildcard policy that was allowed where this route is exposed.</div>
                    <br/>
                </td>
            </tr>
