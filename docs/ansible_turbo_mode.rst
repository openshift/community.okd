...
Following document provides overview of Ansible Turbo mode in ``community.okd`` collection.
...
Synopsis
--------
- A brief introduction about Ansible Turbo mode in ``community.okd`` collection.
