...
from ansible_collections.kubernetes.core.plugins.module_utils.apply import apply as k8s_apply
...
class K8SDynamicClient(DynamicClient):
    def apply(self, resource, body=None, name=None, namespace=None):
        ...
        try:
            with open('/tmp/k8s_apply.txt', 'w') as fh:
                fh.write("Type of k8s_apply is {0}".format(type(k8s_apply)))
